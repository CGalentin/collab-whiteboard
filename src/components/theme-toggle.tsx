...
/**
 * Sun / moon control. Avoids hydration mismatch by rendering a stable shell until mounted.
 */
export function ThemeToggle({
  ...
  return (
    <button
      ...
      className={`inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-700 shadow-sm transition hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700 ${className}`}
